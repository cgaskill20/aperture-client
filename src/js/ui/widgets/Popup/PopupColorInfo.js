...
import { keyToDisplay, valueToDisplay, keyValueIsValid, mongoObjectToSomething } from "./PopupUtils";
    ...
    useEffect(() => {
        if (colorSummary.minMax) {
            ...
            if (obj.properties.meta[colorFieldName]) {
                ...
                console.log({value, minMax: colorSummary.minMax})
                ...
                console.log({xValue: Math.min(Math.max((value - colorSummary.minMax[0]) / (colorSummary.minMax[1] - colorSummary.minMax[0]), 0.0000001), 0.9999999)})
                svg.append('line')
                    .style("stroke", "black")
