...
function updateLayerConstraints(constraints, setConstraints, isChecked, constraint, index) {
...
export default function AdvancedConstraintCheckbox(props) {
    ...
    const handleChange = (event) => {
        ...
        updateLayerConstraints(props.constraints, props.setConstraints, state.checked, props.constraint, props.index);
        // if(props.constraint.type === "slider") {
        //     updateLayerConstraints(props.sliders, props.setSliders, state.checked, props.constraint, props.index)
        // }
        // else if(props.constraint.type === "multiselector") {
        //     updateLayerConstraints(props.checkboxes, props.setCheckboxes, state.checked, props.constraint, props.index)
        // }
    };
