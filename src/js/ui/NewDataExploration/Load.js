...
export default React.memo(function Load({deSerializeWorkspace, setModalOpen}) {
    ...
    return (
        ...
        >
            ...
            <Grid item className={classes.fullWidth}>
                <SavedWorkspaceSlotSelection title="Select a Saved Workspace" setNameOfCurrentSlot={() => {}} slotCurrentlySelected={slotCurrentlySelected} setSlotCurrentlySelected={setSlotCurrentlySelected} onlyShowFullSlots/>
            </Grid>
            <Grid item className={classes.fullWidth}>
